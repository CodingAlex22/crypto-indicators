...
! function() {
    ...
    var k = {
        ...
        x = function() {
            function t(t, i) {
                this.C = new g, this.D = [], this.T = [], this.L = new Map, this.B = t, this.A = i, this.C.i(this.D)
            }
    ...
    var P, F = function() {
                ...
                if (this.it.Y) {
                    ...
                    if (t.fillStyle = this.xt.yt, t.lineWidth = 1, t.lineCap = "butt", c) {
                        ...
                        var C = Math.max(1, Math.floor(r)),
                            ...
                            A = B + C + (B - E),
                            V = Math.round(m * r);
                        t.save(), t.beginPath(), t.moveTo(T, E), t.lineTo(L, E), t.lineTo(L, A), t.lineTo(T, A), t.fill(), t.fillStyle = this.it.X, t.fillRect(k ? N - D : 0, E, D, A - E), this.it.St && (t.fillStyle = this.xt.ut, t.fillRect(T, B, V - T, C)), t.textAlign = "left", t.fillStyle = this.xt.ut, O(t, r, (function() {
        ...
        I = function() {
            function t(t) {
                this.Wt = {
                    ...
                    Ct: !0,
                    X: ""
                }, this.Ut = !0, this.qt = new(t || F)(this.Rt, this.Wt), this.Ht = new(t || F)(this.jt, this.Wt)
            }
            return t.prototype.Vt = function() {
                ...
                return this.Yt(), this.Rt.St = this.Rt.St && t.I().drawTicks, this.jt.St = this.jt.St && t.I().drawTicks, this.qt._(this.Rt, this.Wt), this.Ht._(this.jt, this.Wt), this.qt
            }, t.prototype.Jt = function() {
                return this.Yt(), this.qt._(this.Rt, this.Wt), this.Ht._(this.jt, this.Wt), this.Ht
            }, t.prototype.Yt = function() {
                this.Ut && (this.Rt.St = !0, this.jt.St = !1, this.Gt(this.Rt, this.jt, this.Wt))
            }, t
        }(),
        W = function(t) {
            function i(i, n, h) {
            ...
            return t.prototype._ = function(t) {
                ...
                if (null !== this.it && !1 !== this.it.Y && 0 !== this.it.Vt.length) {
                    ...
                    if (!(s <= 0)) {
                        ...
                        var k = v - i.zt - i.Lt;
                        t.textAlign = "left", t.fillStyle = this.it.ut, O(t, n, (function() {
        ...
        U = function() {
            function t(t, i, n) {
                this.Ut = !0, this.lt = new j, this.ot = {
                    Y: !1,
                    yt: "#4c525e",
                    ut: "white",
                    Vt: "",
            ...
            return t.prototype.V = function() {
                ...
                return this.Ut && (this.R(), this.Ut = !1), this.lt._(this.ot), this.lt
    ...
    var H = function(t) {
            function i(i, n) {
                ...
                h.wi = null, h.Mi = NaN, h.bi = 0, h.mi = !0, h.gi = new Map, h.pi = !1, h.yi = NaN, h.ki = NaN, h.xi = NaN, h.Ni = NaN, h.ri = i, h.Si = n, h.Ci = new x(i, h);
                var s, r;
                h.Di = (s = function() {
                    return h.Mi
                }, r = function() {
            ...
            return r(i, t), i.prototype.I = function() {
                ...
                this.mi = !1, this.Wi(), this.Mi = NaN, this.yi = NaN, this.ki = NaN, this.wi = null, this.Vi()
                ...
                this.Bi.V(), this.gi.forEach((function(t) {
                    return t.V()
                })), this.Li.V(), this.Ci.V()
                ...
                var h = this.yi,
                    ...
                    u = this.wi,
                    a = this.Ui(n);
                this.bi = t, this.yi = isNaN(t) ? NaN : this.ri.q().tt(t), this.wi = n;
                var o = null !== a ? a.K() : null;
                return null !== a && null !== o ? (this.Mi = i, this.ki = a.Z(i, o)) : (this.Mi = NaN, this.ki = NaN), h !== this.yi || s !== this.ki || e !== this.bi || r !== this.Mi || u !== this.wi
            }, i.prototype.Wi = function() {
                var t = this.ri.O().map((function(t) {
                        return t.Yi().Hi()
                    })).filter(b),
    ...
    var $ = function() {
            ...
            return t.prototype.format = function(t) {
                ...
                if (i > 1) {
                    ...
                    r >= i && (r -= i, n += 1), h = Y + K(+r.toFixed(this.Zi) * this.Ki, s)
        ...
        X = function(t) {
            ...
            return r(i, t), i.prototype.format = function(i) {
        ...
        J = function() {
            ...
            return t.prototype.ln = function(t) {
                ...
                return this.on === this.an || Number.isNaN(this.on) || Number.isNaN(this.an)
            }, t.prototype.dn = function(i) {
                return null === i ? this : new t(Math.min(this.cn(), i.cn()), Math.max(this.vn(), i.vn()))
            }, t.prototype.wn = function(t) {
                if (v(t) && 0 !== this.on - this.an) {
                    var i = .5 * (this.on + this.an),
                        n = this.on - i,
                        h = this.an - i;
            ...
            function t(t, i) {
                if (this.gn = t, this.pn = i, function(t) {
                    ...
                    for (var n = this.gn; 1 !== n;) {
                        ...
                        if (this.yn.length > 100) throw new Error("something wrong with base")
                    }
                }
            }
            return t.prototype.kn = function(t, i, n) {
                for (var h, s, r, e = 0 === this.gn ? 0 : 1 / this.gn, u = 1e-9, a = Math.pow(10, Math.max(0, Math.ceil(tt(t - i)))), o = 0, l = this.pn[0];;) {
                    var f = Q(a, e, u) && a > e + u,
                        c = Q(a, n * l, u),
                        v = Q(a, 1, u);
                    if (!(f && c && v)) break;
                ...
                if (a <= e + u && (a = e), a = Math.max(1, a), this.yn.length > 0 && (h = a, s = 1, r = u, Math.abs(h - s) < r))
                    for (o = 0, l = this.yn[0]; Q(a, n * l, u) && a > e + u;) a /= l, l = this.yn[++o % this.yn.length];
                return a
            }, t
        }(),
        ct = function() {
            function t(t, i, n, h) {
                this.xn = [], this.Qt = t, this.gn = i, this.Nn = n, this.Sn = h
            }
            return t.prototype.kn = function(t, i) {
                ...
                var n = this.Qt.Mt(),
                    ...
                    u = [];
                return u.push(s.kn(t, i, h), r.kn(t, i, h), e.kn(t, i, h)),
                    function(t) {
                ...
                if (null !== i) {
                    ...
                    if (a !== o) {
                        for (var l = this.kn(a, o), f = a % l, c = a >= o ? 1 : -1, v = null, _ = 0, d = a - (f += f < 0 ? l : 0); d > o; d -= l) {
                            var w = this.Sn(d, i, !0);
                            null !== v && Math.abs(w - v) < this.Cn() || (w < e || w > u || (_ < this.xn.length ? (this.xn[_].En = w, this.xn[_].Ln = t.Bn(d)) : this.xn.push({
                                En: w,
                                Ln: t.Bn(d)
                            }), _++, v = w, t.An() && (l = this.kn(d * c, o))))
                        }
                        this.xn.length = _
                    } else this.xn = []
                } else this.xn = []
    ...
    var _t, dt = new X,
        ...
        Mt = function() {
            function t(t, i, n, h) {
                this.On = 0, this.zn = null, this.Pn = null, this.Fn = null, this.In = {
                    Wn: !1,
                    Rn: null
                }, this.jn = 0, this.Un = 0, this.qn = new Z, this.Hn = new Z, this.Yn = [], this.Kn = null, this.$n = null, this.Xn = null, this.Zn = null, this.Jn = wt, this.Gn = t, this.Si = i, this.Qn = n, this.th = h, this.ih = new ct(this, 100, this.nh.bind(this), this.hh.bind(this))
            }
            return t.prototype.sh = function() {
                return this.Gn
            }, t.prototype.I = function() {
                return this.Si
            }, t.prototype.rh = function(t) {
                if (c(this.Si, t), this.eh(), void 0 !== t.mode && this.uh({
                        ah: t.mode
                ...
                var i = this.ah(),
                    n = null;
                void 0 !== t.dh && (this.Si.autoScale = t.dh), void 0 !== t.ah && (this.Si.mode = t.ah, 2 !== t.ah && 3 !== t.ah || (this.Si.autoScale = !0), this.In.Wn = !1), 1 === i.ah && t.ah !== i.ah && (! function(t) {
                    if (null === t) return !1;
                    var i = at(t.cn()),
                        n = at(t.vn());
                    return isFinite(i) && isFinite(n)
                }(this.Pn) ? this.Si.autoScale = !0 : null !== (n = function(t) {
                    if (null === t) return null;
                    var i = at(t.cn()),
                        n = at(t.vn());
                    return new J(i, n)
                }(this.Pn)) && this.Mh(n)), 1 === t.ah && t.ah !== i.ah && null !== (n = ot(this.Pn)) && this.Mh(n);
                var h = i.ah !== this.Si.mode;
                h && (2 === i.ah || this.fh()) && this.eh(), h && (3 === i.ah || this._h()) && this.eh(), void 0 !== t.wh && i.wh !== t.wh && (this.Si.invertScale = t.wh, this.bh()), this.Hn.rn(i, this.ah())
                ...
                var n = this.Pn;
                (i || null === n && null !== t || null !== n && !n.ln(t)) && (this.$n = null, this.Pn = t)
            }, t.prototype.ii = function() {
                ...
                return this.fh() ? t = ht(t, i) : this._h() && (t = rt(t, i)), this.hh(t, i)
            }, t.prototype.Ch = function(t, i, n) {
                this.Nh();
                for (var h = this.kh(), s = l(this.xh()), r = s.cn(), e = s.vn(), u = this.ph() - 1, a = this.wh(), o = u / (e - r), f = void 0 === n ? 0 : n.from, c = void 0 === n ? t.length : n.to, v = this.Dh(), _ = f; _ < c; _++) {
                    var d = t[_],
                        w = d.F;
                    if (!isNaN(w)) {
                        var M = w;
                ...
                this.Yn.splice(i, 1), 0 === this.Yn.length && (this.uh({
                    dh: !0
                }), this.Mh(null)), this.eh(), this.Ph()
                ...
                return this.$n || (this.ih.Dn(), this.$n = this.ih.Vn(), this.qn.rn()), this.$n
            }, t.prototype.Wh = function() {
                return this.qn
            }, t.prototype.Rh = function(t) {
                this.fh() || this._h() || null === this.Xn && null === this.Fn && (this.ii() || (this.Xn = this.On - t, this.Fn = l(this.xh()).fn()))
            }, t.prototype.jh = function(t) {
                if (!this.fh() && !this._h() && null !== this.Xn) {
                    this.uh({
                        dh: !1
                    }), (t = this.On - t) < 0 && (t = 0);
                    var i = (this.Xn + .2 * (this.On - 1)) / (t + .2 * (this.On - 1)),
                        n = l(this.Fn).fn();
                ...
                this.lh() || null === this.Zn && null === this.Fn && (this.ii() || (this.Zn = t, this.Fn = l(this.xh()).fn()))
                ...
                this.lh() || null !== this.Zn && (this.Zn = null, this.Fn = null)
                ...
                var t = this.Zh(),
                    i = 100;
                null !== t && (i = Math.round(1 / t.ts())), this.Jn = wt, this.fh() ? (this.Jn = dt, i = 100) : this._h() ? (this.Jn = new $(100, 1), i = 100) : null !== t && (this.Jn = t.Kh()), this.ih = new ct(this, i, this.nh.bind(this), this.hh.bind(this)), this.ih.Dn()
            }, t.prototype.Ph = function() {
                this.Kn = null
            }, t.prototype.Zh = function() {
                return this.Yn[0] || null
            }, t.prototype.yh = function() {
                return this.wh() ? this.Si.scaleMargins.bottom * this.Mt() + this.Un : this.Si.scaleMargins.top * this.Mt() + this.jn
            }, t.prototype.kh = function() {
                return this.wh() ? this.Si.scaleMargins.top * this.Mt() + this.jn : this.Si.scaleMargins.bottom * this.Mt() + this.Un
                ...
                if (null !== t) {
                    ...
                    if (n === this.jn && h === this.Un || (this.jn = n, this.Un = h, this.$n = null, this.oh()), null !== i) {
                        if (i.cn() === i.vn()) {
                            var c = this.Zh(),
                        ...
                        this.Mh(i)
                    } else null === this.Pn && this.Mh(new J(-.5, .5));
                    this.In.Wn = !0
                }
            }, t.prototype.Dh = function() {
                return this.fh() ? ht : this._h() ? rt : this.An() ? ut : null
            }, t.prototype.$h = function(t, i) {
                return void 0 === this.th.priceFormatter ? (void 0 === i && (i = this.Kh()), i.format(t)) : this.th.priceFormatter(t)
            }, t
        }();
    ...
    var pt = function() {
        ...
        yt = function() {
            ...
            return t.prototype.ls = function(t) {
                return this.fs.replace("%h", K(t.getUTCHours(), 2)).replace("%m", K(t.getUTCMinutes(), 2)).replace("%s", K(t.getUTCSeconds(), 2))
            }, t
        }(),
        kt = {
            cs: "yyyy-MM-dd",
    ...
    var Nt = function() {
            function t(t, i) {
                void 0 === i && (i = 50), this.gs = 0, this.ps = 1, this.ys = 1, this.ks = new Map, this.xs = new Map, this.Ns = t, this.Ss = i
            }
            return t.prototype.ls = function(t) {
                ...
                var s = this.Ns(t);
                return this.ks.set(i, {
                    Ts: s,
                    Es: this.ps
                }), this.xs.set(this.ps, i), this.gs++, this.ps++, s
            }, t
        }(),
        St = function() {
            function t(t, i) {
    ...
    var Dt, Tt = function() {
            ...
            return t.prototype.zs = function(t) {
                ...
                this.ks = null, this.Os.clear(), t.forEach((function(t, n) {
                    var h = i.Os.get(t.Ps);
                    void 0 === h && (h = [], i.Os.set(t.Ps, h)), h.push({
                        Fs: n,
                        P: t.P,
                        Is: t.Ps
                    })
                ...
                var n = Math.ceil(i / t);
                return null !== this.ks && this.ks.Rs === n || (this.ks = {
                    Vn: this.js(n),
                    Rs: n
                }), this.ks.Vn
            }, t.prototype.js = function(t) {
                for (var i = [], n = 0, h = Array.from(this.Os.keys()).sort((function(t, i) {
                        return i - t
                    })); n < h.length; n++) {
                    var s = h[n];
                    if (this.Os.get(s)) {
        ...
        Et = function() {
            ...
            return t.prototype.qs = function() {
                return null === this.Us ? null : new St(Math.floor(this.Us.ss()), Math.ceil(this.Us.rs()))
    ...
    var Lt = function() {
        function t(t, i, n) {
            this.Ks = 0, this.$s = null, this.Xs = [], this.Zn = null, this.Xn = null, this.Zs = new Tt, this.Js = new Map, this.Gs = Et.Ys(), this.Qs = !0, this.tr = new Z, this.ir = new Z, this.nr = new Z, this.hr = null, this.sr = null, this.rr = [], this.Si = i, this.th = n, this.er = i.rightOffset, this.ur = i.barSpacing, this.ri = t, this.ar()
        }
        return t.prototype.I = function() {
            ...
            var n;
            c(this.Si, t), this.Si.fixLeftEdge && this.vr(), this.Si.fixRightEdge && this._r(), void 0 !== t.barSpacing && this.ri.dr(t.barSpacing), void 0 !== t.rightOffset && this.ri.wr(t.rightOffset), void 0 !== t.minBarSpacing && this.ri.dr(null !== (n = t.barSpacing) && void 0 !== n ? n : this.ur), this.cr(), this.ar(), this.nr.rn()
        }, t.prototype.ei = function(t) {
            var i;
            return (null === (i = this.Xs[t]) || void 0 === i ? void 0 : i.P) || null
        }, t.prototype.Mr = function(t, i) {
            if (this.Xs.length < 1) return null;
            if (t.Ds > this.Xs[this.Xs.length - 1].P.Ds) return i ? this.Xs.length - 1 : null;
            ...
            for (var t = this.ur, i = 5 * (this.ri.I().layout.fontSize + 4), n = Math.round(i / t), h = l(this.br()), s = Math.max(h.ss(), h.ss() - n), r = Math.max(h.rs(), h.rs() - n), e = 0, u = 0, a = this.Zs.Ws(t, i); u < a.length; u++) {
                var o = a[u];
                if (s <= o.Fs && o.Fs <= r) {
                    var f = this.ei(o.Fs);
                    if (null !== f) {
            ...
            this.Qs = !0, this.dr(this.Si.barSpacing), this.wr(this.Si.rightOffset)
            ...
            this.Zn && this.Yh(), null === this.Xn && null === this.hr && (this.ii() || (this.Xn = t, this.qr()))
        }, t.prototype.jh = function(t) {
            if (null !== this.hr) {
            ...
            null === this.Zn && null === this.hr && (this.ii() || (this.Zn = t, this.qr()))
        }, t.prototype.Hh = function(t) {
            if (null !== this.Zn) {
            ...
            return void 0 !== this.th.timeFormatter ? this.th.timeFormatter(t.Cs || t.Ds) : this.te.ls(new Date(1e3 * t.Ds))
            ...
            return this.Si.fixLeftEdge && this.Si.fixRightEdge ? this.Ks / this.Xs.length : this.Si.minBarSpacing
            ...
            var t = this.kr(),
                i = this.$s;
            return null === t || null === i ? null : t - i - 1 + (this.Si.fixLeftEdge ? this.Ks / this.ur : Math.min(2, this.Xs.length))
        }, t.prototype.re = function() {
            return this.Si.fixRightEdge ? 0 : this.Ks / this.ur - Math.min(2, this.Xs.length)
            ...
            return void 0 === h && (h = new Nt((function(t) {
                return n.ue(t, i)
            })), this.Js.set(i, h)), h.ls(t)
        }, t.prototype.ue = function(t, i) {
            var n, h, s = this.Si.timeVisible;
            return h = i < 20 && s ? this.Si.secondsVisible ? 4 : 3 : i < 40 && s ? 3 : i < 50 || i < 60 ? 2 : i < 70 ? 1 : 0, void 0 !== this.Si.tickMarkFormatter ? this.Si.tickMarkFormatter(null !== (n = t.Cs) && void 0 !== n ? n : t.Ds, h, this.th.locale) : function(t, i, n) {
                var h = {};
                switch (i) {
                    case 0:
                        h.year = "numeric";
    ...
    var Ft = function() {
            ...
            return t.prototype.Me = function(t, i) {
                ...
                this.we = Math.max(this.we, t.we), t.ve.forEach((function(t, n) {
                    i.Me(n, t)
                }))
        ...
        It = function() {
            ...
            return t.prototype.format = function(t) {
                ...
                return ((t = Math.round(t * i) / i) >= 1e-15 && t < 1 ? t.toFixed(this.Ce).replace(/\.?0+$/, "") : String(t)).replace(/(\.[1-9]*)0+$/, (function(t, i) {
                    return i
                }))
            }, t
        }();
    ...
    var Rt = function(t) {
            ...
            return r(i, t), i.prototype._ = function(t) {
                ...
                if (null !== this.v && 0 !== this.v.m.length && null !== this.v.M) {
                    if (t.lineCap = "butt", t.lineJoin = "round", t.strokeStyle = this.v.S, t.lineWidth = this.v.et, n(t, this.v.at), t.lineWidth = 1, t.beginPath(), 1 === this.v.m.length) {
                        var i = this.v.m[0],
                            h = this.v.Te / 2;
                        t.moveTo(i.g - h, this.v.Ee), t.lineTo(i.g - h, i.p), t.lineTo(i.g + h, i.p), t.lineTo(i.g + h, this.v.Ee)
                    } else t.moveTo(this.v.m[this.v.M.from].g, this.v.Ee), t.lineTo(this.v.m[this.v.M.from].g, this.v.m[this.v.M.from].p), Wt(t, this.v.m, this.v.Le, this.v.M), this.v.M.to > this.v.M.from && (t.lineTo(this.v.m[this.v.M.to - 1].g, this.v.Ee), t.lineTo(this.v.m[this.v.M.from].g, this.v.Ee));
                    t.closePath();
        ...
        jt = function(t) {
            ...
            return r(i, t), i.prototype._ = function(t) {
                ...
                if (null !== this.v && 0 !== this.v.m.length && null !== this.v.M) {
                    if (t.lineCap = "butt", t.lineWidth = this.v.et, n(t, this.v.at), t.strokeStyle = this.v.S, t.lineJoin = "round", t.beginPath(), 1 === this.v.m.length) {
                        var i = this.v.m[0];
    ...
    var $t = function() {
            function t(t, i, n) {
                this.Ve = !0, this.Oe = !0, this.ze = !0, this.Pe = [], this.Fe = null, this.Ie = t, this.We = i, this.Re = n
            }
            return t.prototype.V = function(t) {
                this.Ve = !0, "data" === t && (this.Oe = !0), "options" === t && (this.ze = !0)
            }, t.prototype.je = function() {
                this.Oe && (this.Ue(), this.Oe = !1), this.Ve && (this.qe(), this.Ve = !1), this.ze && (this.He(), this.ze = !1)
                ...
                if (this.Ye(), !i.ii() && !t.ii()) {
                    ...
                    if (null !== n && 0 !== this.Ie.Yi().Ke()) {
                        var h = this.Ie.K();
                        null !== h && (this.Fe = Kt(this.Pe, n, this.Re), this.$e(t, i, h.G))
                    }
                }
            }, t
        }(),
        Xt = function(t) {
            ...
            return r(i, t), i.prototype.$e = function(t, i, n) {
            ...
            }, i.prototype.He = function() {}, i.prototype.Ue = function() {
                var t = this,
                    i = this.Ie.Ze();
    ...
    var Jt = function() {
            ...
            return t.prototype._ = function(t) {
                ...
                if (null !== this.it && 0 !== this.it.Yi.length && null !== this.it.M) {
                    if (this.iu = this.hu(i), this.iu >= 2) Math.max(1, Math.floor(i)) % 2 != this.iu % 2 && this.iu--;
                    this.nu = this.it.su ? Math.min(this.iu, Math.floor(i)) : this.iu;
                    for (var s = null, r = this.nu <= this.iu && this.it.Fr >= Math.floor(1.5 * i), e = this.it.M.from; e < this.it.M.to; ++e) {
                        var u = this.it.Yi[e];
                        s !== u.ut && (t.fillStyle = u.ut, s = u.ut);
                        var a = Math.floor(.5 * this.nu),
                            o = Math.round(u.g * i),
                            l = o - a,
                            f = this.nu,
                            c = l + f - 1,
            ...
            return t.prototype._ = function(t) {
                ...
                if (null !== this.it && 0 !== this.it.Yi.length && null !== this.it.M) {
                    if (this.iu = function(t, i) {
                        ...
                        }(this.it.Fr, i), this.iu >= 2) Math.floor(i) % 2 != this.iu % 2 && this.iu--;
                    var s = this.it.Yi;
                    this.it.ou && this.lu(t, s, this.it.M, i), this.it.fu && this.cu(t, s, this.it.M, this.it.Fr, i);
                    var r = this.vu(i);
                ...
                this.iu <= 2 * i && (i = Math.floor(.5 * (this.iu - 1)));
                var n = Math.max(Math.floor(t), i);
                return this.iu <= 2 * n ? Math.max(Math.floor(t), Math.floor(1 * t)) : n
            }, t.prototype.cu = function(t, i, n, h, s) {
                if (null !== this.it)
                    for (var r = "", e = this.vu(s), u = null, a = n.from; a < n.to; a++) {
                        var o = i[a];
                        o.X !== r && (t.fillStyle = o.X, r = o.X);
                        var l = Math.round(o.g * s) - Math.floor(.5 * this.iu),
                            f = l + this.iu - 1,
                            c = Math.round(Math.min(o.Eh, o.Ah) * s),
                            v = Math.round(Math.max(o.Eh, o.Ah) * s);
                        if (null !== u && (l = Math.max(u + 1, l), l = Math.min(l, f)), this.it.Fr * s > 2 * e) V(t, l, c, f - l + 1, v - c + 1, e);
                        else {
                            var _ = f - l + 1;
        ...
        ni = function() {
            ...
            return t.prototype._ = function(t) {
                ...
                if (null !== this.it && 0 !== this.it.m.length && null !== this.it.M) {
                    this.bu.length || this.mu(i);
                    for (var s = Math.max(1, Math.floor(i)), r = Math.round(this.it.gu * i) - Math.floor(s / 2), e = r + s, u = this.it.M.from; u < this.it.M.to; u++) {
                        var a = this.it.m[u],
                ...
                if (null !== this.it && 0 !== this.it.m.length && null !== this.it.M) {
                    var i = Math.ceil(this.it.Fr * t) <= 1 ? 0 : Math.max(1, Math.floor(t)),
                    ...
                    if (i > 0 && f < 4)
                        for (h = this.it.M.from; h < this.it.M.to; h++) {
                            (c = (o = this.bu[h - this.it.M.from]).rs - o.ss + 1) > f && (o.pu > o.yu ? o.rs -= 1 : o.ss += 1)
                        }
                } else this.bu = []
            }, t
        }();
    ...
    var ri = function(t) {
            ...
            return r(i, t), i.prototype.W = function(t, i) {
                ...
                var t = this.We.q().Fr();
                this.ku = hi(t);
                for (var i = 0, n = 0, h = this.Ie.I().color, s = 0, r = this.Ie.Yi().Je(); s < r.length; s++) {
                    var e = r[s],
                        u = e.G[3],
                        a = void 0 !== e.ut ? e.ut : h,
                        o = si(e.Fs, u, a);
                    ++i < this.ku.m.length ? this.ku.m[i] = o : this.ku.m.push(o), this.Pe[n++] = {
                        P: e.Fs,
                        g: 0
                    }
                }
                this.lt._(this.ku), this.C.i([this.lt])
            }, i.prototype.He = function() {}, i.prototype.Ye = function() {
        ...
        ai = function() {
            function t(t) {
                void 0 === t && (t = 50), this.ks = new Map, this.xu = 0, this.Nu = Array.from(new Array(t))
            }
        ...
        oi = function() {
            function t(t) {
                this.Cu = null, this.ae = null, this.Du = "right", this.Ks = 0, this.Tu = t
            }
            return t.prototype.Eu = function(t, i, n, h) {
                this.Cu = t, this.ae = i, this.Ks = n, this.Du = h
            }, t.prototype.h = function(t, i) {
                null !== this.ae && null !== this.Cu && this.Cu.h(t, this.ae, this.Tu, this.Ks, this.Du, i)
            }, t
        }(),
        li = function() {
            function t(t, i, n) {
                this.Lu = t, this.Tu = new ai(50), this.Bu = i, this.B = n, this.le = -1, this.lt = new oi(this.Tu)
            }
        ...
        ci = function() {
            function t(t) {
                this.Pu = {
                    ...
                    at: 0,
                    Y: !1
                }, this.Fu = new fi, this.Ut = !0, this.Ie = t, this.We = t.ct(), this.Fu._(this.Pu)
            }
            return t.prototype.V = function() {
                this.Ut = !0
            }, t.prototype.W = function(t, i) {
                return this.Ie.Y() ? (this.Ut && (this.Iu(t, i), this.Ut = !1), this.Fu) : null
            }, t
        }(),
        vi = function(t) {
            function i(i) {
            ...
            return r(i, t), i.prototype.Iu = function(t, i) {
                ...
                if (2 === h || 3 === h) {
                    ...
                    if (s.baseLineVisible && this.Ie.Y()) {
                        var r = this.Ie.K();
                        null !== r && (this.Pu.Y = !0, this.Pu.p = n.Z(r.G, r.G), this.Pu.wt = i, this.Pu.Mt = t, this.Pu.ut = s.baseLineColor, this.Pu.et = s.baseLineWidth, this.Pu.at = s.baseLineStyle)
                    }
                }
            }, i
        }(ci);
    ...
    var pi = function(t) {
        ...
        return r(i, t), i.prototype._ = function(t) {
            ...
            this.le === t && this.fe === i || (this.le = t, this.fe = i, this.Wu = Ot(t, i), this.Tu.Su())
    ...
    function yi(t, i) {
        i.fillStyle = t.ut, void 0 !== t.Vt && function(t, i, n, h) {
                t.fillText(i, n, h)
    ...
    function xi(t, i, n, h, s, r, e, u, a) {
        ...
        switch (t.Ke = _, i.position) {
            case "inBar":
                return t.p = e.Z(o, a), void(void 0 !== t.Vt && (t.Vt.p = t.p + d + r + .6 * s));
            case "aboveBar":
                return t.p = e.Z(l, a) - d - h.Ku, void 0 !== t.Vt && (t.Vt.p = t.p - d - .6 * s, h.Ku += 1.2 * s), void(h.Ku += _ + r);
            case "belowBar":
                return t.p = e.Z(f, a) + d + h.$u, void 0 !== t.Vt && (t.Vt.p = t.p + d + r + .6 * s, h.$u += 1.2 * s), void(h.$u += _ + r)
        }
        i.position
    }
    var Ni = function() {
            function t(t, i) {
                this.Ut = !0, this.Xu = !0, this.Zu = !0, this.Ju = null, this.lt = new pi, this.Gu = t, this.ri = i, this.it = {
                    m: [],
                    M: null
                }
            }
            return t.prototype.V = function(t) {
                ...
                var t = this.Gu.J(),
                    i = this.ri.q(),
                    n = this.Gu.ta();
                this.Xu && (this.it.m = n.map((function(t) {
                    return {
                        P: t.time,
                        g: 0,
                        p: 0,
                ...
                if (null !== s) {
                    ...
                    if (null !== r && 0 !== this.it.m.length) {
                        ...
                        for (var o = this.it.M.from; o < this.it.M.to; o++) {
                            ...
                            var f = this.it.m[o];
                            f.g = i.tt(l.time), void 0 !== l.text && l.text.length > 0 && (f.Vt = {
                                Hu: l.text,
                                p: 0,
                                wt: 0,
                                Mt: 0
            ...
            return r(i, t), i.prototype.Gt = function(t, i, n) {
                if (t.Y = !1, i.Y = !1, this.ft.Y()) {
                    var h = this.ft.I(),
                        ...
                        u = this.ft.na(!1);
                    if (!u.ha) {
                        s && (t.Vt = this.ea(u, s, e), t.Y = 0 !== t.Vt.length), (r || e) && (i.Vt = this.ua(u, s, r, e), i.Y = i.Vt.length > 0);
                ...
                var s = "",
                    r = this.ft.ra();
                return n && 0 !== r.length && (s += r + " "), i && h && (s += this.ft.J().fh() ? t.aa : t.oa), s.trim()
        ...
        Di = function() {
            ...
            return t.prototype.xh = function() {
                ...
                return null === this.Pn ? null : {
                    priceRange: this.Pn.bn(),
                    margins: this.la || void 0
                }
            }, t.mn = function(i) {
        ...
        Ei = function(t) {
            ...
            return r(i, t), i.prototype.Gt = function(t, i, n) {
                ...
                if (s && this.Gu.Y()) {
                    var e = this.fa.ca();
                    if (null !== e) {
                        r && (i.Vt = h.title, i.Y = !0), i.X = this.Gu.ct().I().layout.backgroundColor, t.Vt = this.Gu.J().Xh(h.price), t.Y = !0;
                        var u = A(h.color);
        ...
        Li = function() {
            function t(t, i) {
                this.Gu = t, this.Si = i, this.va = new Ti(t, this), this.Lu = new Ei(t, this), this._a = new li(this.Lu, t, t.ct())
            }
        ...
        zi = function() {
            ...
            return t.prototype.Ca = function() {
                ...
                void 0 === i && (i = 0);
                var n = this.La(t, i);
                return null === n ? null : e(e({}, this.Aa(n)), {
                    Fs: this.Ea(n)
                })
            }, t.prototype.Je = function() {
                return this.xa
                ...
                0 !== t.length && (this.ii() || t[t.length - 1].Fs < this.xa[0].Fs ? this.za(t) : t[0].Fs > this.xa[this.xa.length - 1].Fs ? this.Pa(t) : 1 !== t.length || t[0].Fs !== this.xa[this.xa.length - 1].Fs ? this.Fa(t) : this.Ia(t[0]))
                ...
                a(0 !== t.length, "plotRows should not be empty"), this.Sa.clear(), this.Na.clear(), this.xa = t.concat(this.xa)
            }, t.prototype.Pa = function(t) {
                a(0 !== t.length, "plotRows should not be empty"), this.Sa.clear(), this.Na.clear(), this.xa = this.xa.concat(t)
            }, t.prototype.Ia = function(t) {
                a(!this.ii(), "plot list should not be empty"), a(this.xa[this.xa.length - 1].Fs === t.Fs, "last row index should match new row index"), this.$a(t), this.Sa.delete(t.Fs), this.xa[this.xa.length - 1] = t
            }, t.prototype.Fa = function(t) {
                a(0 !== t.length, "plot rows should not be empty"), this.Sa.clear(), this.Na.clear(), this.xa = function(t, i) {
                    var n = function(t, i) {
                            var n = t.length,
                                h = i.length,
                                s = n + h,
                                r = 0,
                                e = 0;
                            for (; r < n && e < h;) t[r].Fs < i[e].Fs ? r++ : t[r].Fs > i[e].Fs ? e++ : (r++, e++, s--);
                            return s
                        }(t, i),
                        h = new Array(n),
                        s = 0,
                        ...
                        u = i.length,
                        a = 0;
                    for (; s < e && r < u;) t[s].Fs < i[r].Fs ? (h[a] = t[s], s++) : t[s].Fs > i[r].Fs ? (h[a] = i[r], r++) : (h[a] = i[r], s++, r++), a++;
                    for (; s < e;) h[a] = t[s], s++, a++;
                    for (; r < u;) h[a] = i[r], r++, a++;
                    return h
                }(this.xa, t)
    ...
    function Pi(t, i) {
        return null === t ? i : null === i ? t : {
            Ya: Math.min(t.Ya, i.Ya),
            Ka: Math.max(t.Ka, i.Ka)
        }
    }
    var Fi = function(t) {
            function i(i, n, h) {
                var s = t.call(this, i) || this;
                s.it = new zi, s.va = new Si(s), s.Xa = [], s.Za = new vi(s), s.Ja = null, s.Ga = [], s.Qa = [], s.Si = n, s.io = h;
                var r = new Ci(s);
                return s.gi = [r], s._a = new li(r, s, i), s.no(), s.ho(), s
            }
            return r(i, t), i.prototype.un = function() {}, i.prototype.sa = function(t) {
                ...
                var i, n = t.priceScaleId;
                void 0 !== n && n !== this.Si.priceScaleId && this.ct().so(this, n);
                var h = null !== (i = this.Si.pane) && void 0 !== i ? i : 0;
                c(this.Si, t), null !== this.ai && void 0 !== t.scaleMargins && this.ai.rh({
                    scaleMargins: t.scaleMargins
                }), void 0 !== t.priceFormat && this.no(), t.pane && h !== t.pane && this.ct().ro(this, h, t.pane), this.ct().eo(this), this.ct().uo(), this.Bi.V("options")
            }, i.prototype.ao = function() {
                this.it.Ca(), this.ho()
            }, i.prototype.oo = function(t, i) {
                i && this.it.Ca(), this.it.dn(t), this.lo(), this.Bi.V("data"), this.Ci.V("data");
                ...
                var i = this.Xa.indexOf(t); - 1 !== i && this.Xa.splice(i, 1), this.ct().eo(this)
                ...
                var i = this.it.ka(t);
                return null === i ? null : "Bar" === this.io || "Candlestick" === this.io ? {
                    open: i.G[0],
                    high: i.G[1],
                    low: i.G[2],
                    close: i.G[3]
                ...
                if (!(("Line" === this.io || "Area" === this.io) && this.Si.crosshairMarkerVisible)) return null;
                var i = this.it.ka(t);
                return null === i ? null : {
                    F: i.G[3],
                    N: this.bo(),
                ...
                var n = "Line" === this.io || "Area" === this.io || "Histogram" === this.io ? [3] : [2, 1],
                    h = this.it.Va(t, i, n),
                ...
                switch (this.Si.priceFormat.type) {
                    case "custom":
                        this.Jn = {
                            format: this.Si.priceFormat.formatter
                        };
                        break;
                    case "volume":
        ...
        Ui = function() {
            function t(t, i) {
                this.Yn = [], this.Bo = new Map, this.On = 0, this.Ks = 0, this.Ao = 1e3, this.Kn = null, this.Vo = new Z, this.Oo = t, this.ri = i, this.zo = new ji(this);
                var n = i.I();
            ...
            return t.prototype.Ro = function(t) {
                if (t.leftPriceScale && this.Po.rh(t.leftPriceScale), t.rightPriceScale && this.Io.rh(t.rightPriceScale), t.localization && (this.Po.eh(), this.Io.eh()), t.overlayPriceScales)
                    for (var i = 0, n = Array.from(this.Bo.values()); i < n.length; i++) {
                        var h = l(n[i][0].J());
                ...
                this.ct().Uo().sn(this), this.Po.mh().sn(this), this.Io.mh().sn(this), this.Yn.forEach((function(t) {
                    t.un && t.un()
                })), this.Vo.rn()
                ...
                var i = this.Yn.indexOf(t);
                a(-1 !== i, "removeDataSource: invalid data source"), this.Yn.splice(i, 1);
                var n = l(t.J()).sh();
                if (this.Bo.has(n)) {
                    var h = o(this.Bo.get(n)),
                        s = h.indexOf(t); - 1 !== s && (h.splice(s, 1), 0 === h.length && this.Bo.delete(n))
                }
                var r = t.J();
                r && r.j().indexOf(t) >= 0 && r.Fh(t), null !== r && (r.Ph(), this.Zo(r)), this.Kn = null
                ...
                var t = null;
                return this.ri.I().rightPriceScale.visible && 0 !== this.Io.j().length ? t = this.Io : this.ri.I().leftPriceScale.visible && 0 !== this.Po.j().length ? t = this.Po : 0 !== this.Yn.length && (t = this.Yn[0].J()), null === t && (t = this.Io), t
                ...
                t.uh({
                    dh: !0
                }), null !== i && t.Qh(i), this.Yo()
            }, t.prototype.ul = function() {
                this.rl(this.Po), this.rl(this.Io)
            }, t.prototype.al = function() {
                var t = this;
                this.Zo(this.Po), this.Zo(this.Io), this.Yn.forEach((function(i) {
                    t.Vu(i) && t.Zo(i.J())
                })), this.Yo(), this.ri.Pr()
            }, t.prototype.Oh = function() {
                ...
                var h = this.jo(i);
                if (null === h && (h = this.Fo(i, this.ri.I().overlayPriceScales)), this.Yn.push(t), !Pt(i)) {
                    var s = this.Bo.get(i) || [];
        ...
        Hi = function() {
            ...
            return t.prototype.V = function() {
                ...
                var n = this.ft.I(),
                    h = this.ot;
                h.Y = n.visible, h.Y && (h.ut = n.color, h.wt = i, h.Mt = t, h.Ml = n.horzAlign, h.wl = n.vertAlign, h.vl = [{
                    Vt: n.text,
        ...
        Ki = function() {
            function t(t, i) {
                this.gl = [], this.pl = [], this.Ks = 0, this.yl = null, this.kl = null, this.xl = new Z, this.Nl = new Z, this.Sl = !1, this.Cl = t, this.Si = i, this.Dl = new zt(this), this.Oo = new Lt(this, i.timeScale, this.Si.localization), this.A = new H(this, i.crosshair), this.Tl = new Ii(i.crosshair), this.El = new Yi(this, i.watermark), this.Ll(), this.gl[0].Ho(2e3)
            }
            return t.prototype.Bl = function() {
                ...
                var i = this.kl;
                this.kl = t, null !== i && this.eo(i.Pl), null !== t && this.eo(t.Pl)
            }, t.prototype.I = function() {
                return this.Si
            }, t.prototype.rh = function(t) {
                c(this.Si, t), this.gl.forEach((function(i) {
                    return i.Ro(t)
                })), void 0 !== t.timeScale && this.Oo.rh(t.timeScale), void 0 !== t.localization && this.Oo.lr(t.localization), (t.leftPriceScale || t.rightPriceScale) && this.xl.rn(), this.Bl()
                ...
                this.Ks = t, this.Oo.Dr(this.Ks), this.gl.forEach((function(i) {
                    return i.Dr(t)
                })), this.zr()
                ...
                var i = this;
                if (0 !== t) {
                    if (this.gl[t].Oh().forEach((function(t) {
                            t instanceof Fi && i.Yl(t)
                        })), this.Sl = !0, t !== this.gl.length - 1)
                        for (var n = function(t) {
                                h.gl[t].Oh().forEach((function(i) {
                                    i instanceof Fi && i.rh({
                                        pane: t - 1
                                    })
                                }))
                            }, h = this, s = t + 1; s < this.gl.length; s++) n(s);
                ...
                var n = this.gl[t],
                    h = this.gl[i];
                this.Sl = !0, n.Oh().forEach((function(t) {
                    t instanceof Fi && t.rh({
                        pane: i
                    })
                ...
                })), this.gl[t] = h, this.gl[i] = n, this.Sl = !1, this.Al(new Ft(3))
                ...
                var i = !1;
                return null !== this.yl && Math.abs(t - this.yl) > 20 && (this.yl = null, i = !0), this.Oo.Hh(t), this.zr(), i
                ...
                var e = n.Ti(),
                    u = e.K();
                null !== u && (h = e.Ei(i, u)), h = this.Tl.yo(h, s, n), this.A.Pi(s, h, n), this.sf(), this.Nl.rn(this.A.U(), {
                    x: t,
                    y: i
                })
                ...
                this.El.ji(), this.gl.forEach((function(t) {
                    return t.al()
                })), this.uo()
            }, t.prototype.un = function() {
                this.gl.forEach((function(t) {
                    return t.un()
                })), this.gl.length = 0, this.Si.localization.priceFormatter = void 0, this.Si.localization.timeFormatter = void 0
                ...
                var h = this.gl[n],
                    s = this.lf(i, t, h);
                return this.pl.push(s), 1 === this.pl.length ? this.Bl() : this.Pr(), s
            }, t.prototype.Yl = function(t) {
                var i = this.Au(t),
                    n = this.pl.indexOf(t);
                a(-1 !== n, "Series not found"), this.pl.splice(n, 1), l(i).Fh(t), t.un && t.un()
                ...
                this.Cl && this.Cl(t), this.gl.forEach((function(t) {
                    return t.ll().Lo().V()
                }))
    ...
    var sn = function() {
        ...
        rn = function() {
            function t(t, i, n) {
                this._f = 0, this.df = null, this.wf = null, this.Mf = !1, this.bf = null, this.mf = !1, this.gf = !1, this.pf = null, this.yf = null, this.kf = null, this.xf = null, this.Nf = 0, this.Sf = !1, this.Cf = !1, this.Df = !1, this.Tf = t, this.Ef = i, this.Si = n, this.Lf()
            }
            return t.prototype.un = function() {
                null !== this.pf && (this.pf(), this.pf = null), null !== this.yf && (this.yf(), this.yf = null), null !== this.kf && (this.kf(), this.kf = null), this.Bf(), this.Af()
                ...
                }, this.Tf.addEventListener("mousemove", n), an(t) && this.Of(t);
                var h = this.zf(t);
                this.Pf(h, this.Ef.Ff)
            }, t.prototype.Af = function() {
                null !== this.df && clearTimeout(this.df), this._f = 0, this.df = null
                ...
                if (!("button" in t) || 0 === t.button) {
                    var i = this.zf(t);
                    this.Bf(), this.bf = null, this.Df = !1, this.kf && (this.kf(), this.kf = null), an(t) && this.Kf(t), this.Pf(i, this.Ef.$f), ++this._f, this.df && this._f > 1 ? (this.Pf(i, this.Ef.Xf), this.Af()) : this.gf || this.Pf(i, this.Ef.Zf), an(t) && (on(t), this.Kf(t), 0 === t.touches.length && (this.Mf = !1))
                }
                ...
                if (!("button" in t) || 0 === t.button) {
                    var i = this.zf(t);
                    this.gf = !1, this.mf = !1, this.Cf = !1, an(t) && this.Vf(t), this.bf = {
                        g: i.Rf,
                        p: i.jf
                    ...
                    this.kf = function() {
                        ...
                        passive: !1
                    }), this.Bf(), an(t) && 1 === t.touches.length ? this.wf = setTimeout(this.Gf.bind(this, t), 240) : (s.addEventListener("mousemove", n), s.addEventListener("mouseup", h)), this.Df = !0, this.Pf(i, this.Ef.Qf), this.df || (this._f = 0, this.df = setTimeout(this.Af.bind(this), 500))
                }
            }, t.prototype.Lf = function() {
                var t = this;
                this.Tf.addEventListener("mouseenter", this.Vf.bind(this)), this.Tf.addEventListener("touchcancel", this.Bf.bind(this));
                var i = this.Tf.ownerDocument,
                    n = function(i) {
                        t.Ef.tc && (i.composed && t.Tf.contains(i.composedPath()[0]) || i.target && t.Tf.contains(i.target) || t.Ef.tc())
                    };
                this.pf = function() {
                    ...
                    passive: !0
                }), this.Tf.addEventListener("mouseleave", this.Kf.bind(this)), this.Tf.addEventListener("touchstart", this.Jf.bind(this), {
                    passive: !0
                }), hn || this.Tf.addEventListener("mousedown", this.Jf.bind(this)), this.ic(), this.Tf.addEventListener("touchmove", (function() {}), {
                    passive: !1
                })
            }, t.prototype.ic = function() {
                var t = this;
                void 0 === this.Ef.nc && void 0 === this.Ef.hc && void 0 === this.Ef.sc || (this.Tf.addEventListener("touchstart", (function(i) {
                    return t.rc(i.touches)
                }), {
                    passive: !0
                }), this.Tf.addEventListener("touchmove", (function(i) {
                    if (2 === i.touches.length && null !== t.xf && void 0 !== t.Ef.hc) {
                ...
                1 === t.length && (this.Sf = !1), 2 !== t.length || this.Sf || this.Mf ? this.ec() : this.uc(t)
            }, t.prototype.uc = function(t) {
                var i = en(this.Tf);
                this.xf = {
                    g: (t[0].clientX - i.left + (t[1].clientX - i.left)) / 2,
                    p: (t[0].clientY - i.top + (t[1].clientY - i.top)) / 2
                }, this.Nf = un(t[0], t[1]), void 0 !== this.Ef.nc && this.Ef.nc(), this.Bf()
            }, t.prototype.ec = function() {
                null !== this.xf && (this.xf = null, void 0 !== this.Ef.sc && this.Ef.sc())
    ...
    var ln = function() {
            function t(t, i, n, h, s) {
                if (this.yc = 0, this.kc = 0, this.xc = 0, this.Nc = 0, this.Sc = 0, this.Cc = 0, this.Dc = 0, this.Tc = !1, this.Ec = t, this.Lc = t.Bc()[i], this.Ac = t.Bc()[n], this.Vc = document.createElement("tr"), this.Vc.style.height = "1px", this.Oc = i, this.zc = n, this.Pc = s, this.Fc = document.createElement("td"), this.Fc.style.position = "relative", this.Fc.style.padding = "0", this.Fc.style.margin = "0", this.Fc.setAttribute("colspan", "3"), this.Ic(), this.Vc.appendChild(this.Fc), h) this.Wc = null, this.Rc = null;
                    ...
                    this.Wc = document.createElement("div"), this.Wc.style.position = "absolute", this.Wc.style.zIndex = "50", this.Wc.style.top = "-4px", this.Wc.style.height = "9px", this.Wc.style.width = "100%", this.Wc.style.backgroundColor = "", this.Wc.style.cursor = "row-resize", this.Fc.appendChild(this.Wc);
                    var r = {
            ...
            return t.prototype.un = function() {
                ...
                null !== this.Wc && (this.Wc.style.backgroundColor = "hsla(225,8%,72%,.2)")
            }, t.prototype.Uc = function(t) {
                null === this.Wc || this.Tc || (this.Wc.style.backgroundColor = "")
            }, t.prototype.qc = function(t) {
                this.yc = t.jf, this.kc = 0, this.xc = this.Lc.$c().rt + this.Ac.$c().rt, this.Nc = this.Lc.qo() + this.Ac.qo(), this.Sc = 30, this.Cc = this.xc - this.Sc, this.Dc = this.Nc / this.xc, this.Tc = !0
                ...
                var n = this.Lc.$c().rt,
                    ...
                    s = this.Nc - h;
                this.Lc.Ho(h), this.Ac.Ho(s), this.Ec.Zc(), this.Lc.$c().rt !== n && (this.yc = t.jf), this.Ec.ct().Bl(), this.Pc.rn((function() {
                    return {
                        Jc: {
                            Fs: i.Oc,
                            Mt: i.Lc.$c().rt
                ...
                this.yc = 0, this.kc = 0, this.xc = 0, this.Nc = 0, this.Sc = 0, this.Cc = 0, this.Dc = 0, this.Tc = !1, this.Uc(t)
            }, t
        }(),
        fn = function() {
            function t(t, i, n, h) {
                this.Tu = new ai(200), this.le = 0, this.Gc = "", this.Wu = "", this.Nu = [], this.Qc = new Map, this.le = t, this.Gc = i, this.Wu = Ot(t, n, h)
            }
            return t.prototype.un = function() {
                ...
                if (this.Qc.has(i)) n = o(this.Qc.get(i));
                    ...
                    n = {
                        ...
                        Mt: Math.ceil(f * r),
                        hv: c
                    }, 0 !== a && (this.Nu.push(n.Vt), this.Qc.set(n.Vt, n)), O(t = Gi(n.hv), r, (function() {
                        t.font = h.Wu, t.fillStyle = h.Gc, t.fillText(i, 0, f - e - u)
                    }))
                }
                return n
            }, t
        ...
        cn = function() {
            function t(t, i, n, h) {
                var s = this;
                this.Qt = null, this.sv = null, this.rv = null, this.ev = !1, this.uv = new ai(50), this.av = new fn(11, "#000"), this.Gc = null, this.Wu = null, this.ov = 0, this.lv = function() {
                    s.fv(s.Dl.I()), s.wi.cv().ct().Pr()
                }, this.vv = function() {
                    s.wi.cv().ct().Pr()
                }, this.wi = t, this.Si = i, this.Dl = n, this._v = "left" === h, this.Fc = document.createElement("div"), this.Fc.style.height = "100%", this.Fc.style.overflow = "hidden", this.Fc.style.width = "25px", this.Fc.style.left = "0", this.Fc.style.position = "relative", this.dv = tn(this.Fc, new Zi(16, 16)), this.dv.subscribeCanvasConfigured(this.lv);
                var r = this.dv.canvas;
                r.style.position = "absolute", r.style.zIndex = "1", r.style.left = "0", r.style.top = "0", this.wv = tn(this.Fc, new Zi(16, 16)), this.wv.subscribeCanvasConfigured(this.vv);
                ...
                this.Rc = new rn(this.wv.canvas, u, {
                    Uf: !1,
                    qf: !0
                })
            }
            return t.prototype.un = function() {
                this.Rc.un(), this.wv.unsubscribeCanvasConfigured(this.vv), this.wv.destroy(), this.dv.unsubscribeCanvasConfigured(this.lv), this.dv.destroy(), null !== this.Qt && this.Qt.Wh().sn(this), this.Qt = null, null !== this.rv && (clearTimeout(this.rv), this.rv = null), this.av.un()
            }, t.prototype.Kc = function() {
                return this.Fc
                ...
                var t = 34,
                    ...
                    n = Gi(this.dv.canvas),
                    h = this.Qt.Vn();
                n.font = this.pv(), h.length > 0 && (t = Math.max(this.uv.Ot(n, h[0].Ln), this.uv.Ot(n, h[h.length - 1].Ln)));
                ...
                null !== this.sv && this.sv.ln(t) || (this.sv = t, this.dv.resizeCanvas({
                    width: t.st,
                    height: t.rt
                }), this.wv.resizeCanvas({
                    width: t.st,
                    height: t.rt
                }), this.Fc.style.width = t.st + "px", this.Fc.style.height = t.rt + "px", this.Fc.style.minWidth = t.st + "px")
            }, t.prototype.Sv = function() {
                return l(this.sv).st
            }, t.prototype.ci = function(t) {
                this.Qt !== t && (null !== this.Qt && this.Qt.Wh().sn(this), this.Qt = t, t.Wh().Gi(this.qn.bind(this), this))
            }, t.prototype.J = function() {
                return this.Qt
                ...
                if (null !== this.Qt && !this.Qt.ii() && this.wi.cv().I().handleScale.axisPressedMouseMove.price) {
                    var i = this.wi.cv().ct(),
                        n = this.wi.Cv();
                    this.ev = !0, i.Qo(n, this.Qt, t.dc)
                }
            }, t.prototype.Hc = function(t) {
                if (null !== this.Qt && this.wi.cv().I().handleScale.axisPressedMouseMove.price) {
                    var i = this.wi.cv().ct(),
                        n = this.wi.Cv(),
                        h = this.Qt;
                    i.tl(n, h, t.dc)
                ...
                null !== this.Qt && (!this.wi.cv().ct().I().handleScale.axisPressedMouseMove.price || this.Qt.fh() || this.Qt._h() || this.Vv(1))
            }, t.prototype.Uc = function(t) {
                this.Vv(0)
                ...
                return function(h) {
                    for (var s = 0; s < h.length; ++s)
                        for (var r = h[s].vi(t.wi.Cv(), n), e = 0; e < r.length; e++) i.push(r[e])
                }(this.wi.Cv().Oh()), i
                ...
                if (null !== this.sv && null !== this.Qt && this.Qt.I().borderVisible) {
                    t.save(), t.fillStyle = this.S();
                    var n, h = Math.max(1, Math.floor(this.yv().Tt * i));
                ...
                if (null !== this.sv && null !== this.Qt) {
                    var n = this.Qt.Vn();
                    t.save(), t.strokeStyle = this.S(), t.font = this.pv(), t.fillStyle = this.S();
                    var h = this.yv(),
                ...
                if (null !== this.sv && null !== this.Qt) {
                    var t = this.sv.rt / 2,
                        ...
                        h = this.wi.Cv(),
                        s = this.yv();
                    this.Qt === h.Ti() && this.wi.Cv().Oh().forEach((function(t) {
                        h.Vu(t) && n.push(t)
                    }));
                    var r = this.Qt.j()[0],
                        e = this.Qt;
                ...
                if (this.ov < i) {
                    var n = this.wi.cv();
                    null === this.rv && (this.rv = setTimeout((function() {
                        n && n.ct().Bl(), t.rv = null
                    }), 100))
                }
                this.ov = i
        ...
        _n = function() {
            function t(t, i) {
                var n = this;
                this.sv = new Zi(0, 0), this.Ov = null, this.zv = null, this.Pv = null, this.Fv = !1, this.Iv = new Z, this.Wv = 0, this.Rv = !1, this.jv = null, this.Uv = !1, this.qv = null, this.lv = function() {
                    return n.Hv && n.ri().Pr()
                }, this.vv = function() {
                    return n.Hv && n.ri().Pr()
                }, this.Yv = t, this.Hv = i, this.Hv.ol().Gi(this.Kv.bind(this), this, !0), this.$v = document.createElement("td"), this.$v.style.padding = "0", this.$v.style.position = "relative";
                var h = document.createElement("div");
                h.style.width = "100%", h.style.height = "100%", h.style.position = "relative", h.style.overflow = "hidden", this.Xv = document.createElement("td"), this.Xv.style.padding = "0", this.Zv = document.createElement("td"), this.Zv.style.padding = "0", this.$v.appendChild(h), this.dv = tn(h, new Zi(16, 16)), this.dv.subscribeCanvasConfigured(this.lv);
                var s = this.dv.canvas;
                s.style.position = "absolute", s.style.zIndex = "1", s.style.left = "0", s.style.top = "0", this.wv = tn(h, new Zi(16, 16)), this.wv.subscribeCanvasConfigured(this.vv);
                var r = this.wv.canvas;
                r.style.position = "absolute", r.style.zIndex = "2", r.style.left = "0", r.style.top = "0", this.Vc = document.createElement("tr"), this.Vc.appendChild(this.Xv), this.Vc.appendChild(this.$v), this.Vc.appendChild(this.Zv), this.Jv();
            ...
            return t.prototype.un = function() {
                null !== this.Ov && this.Ov.un(), null !== this.zv && this.zv.un(), this.wv.unsubscribeCanvasConfigured(this.vv), this.wv.destroy(), this.dv.unsubscribeCanvasConfigured(this.lv), this.dv.destroy(), null !== this.Hv && this.Hv.ol().sn(this), this.Rc.un()
            }, t.prototype.Cv = function() {
                return l(this.Hv)
            }, t.prototype.Gv = function(i) {
                null !== this.Hv && this.Hv.ol().sn(this), this.Hv = i, null !== this.Hv && this.Hv.ol().Gi(t.prototype.Kv.bind(this), this, !0), this.Jv()
            }, t.prototype.cv = function() {
                return this.Yv
            }, t.prototype.Kc = function() {
                return this.Vc
                ...
                if (null !== this.Hv) {
                    var i = t._c,
                        n = t.dc,
                        h = this.Ru(i, n);
                    if (null !== h && void 0 !== h.gc.r_ && h.gc.r_(i, n), this.Iv.en()) {
                        var s = this.ri().jl().U();
                        this.Iv.rn(s, {
                            x: i,
                            y: n
                ...
                if (null !== this.Hv) {
                    ...
                    if (!i.q().ii()) {
                        ...
                        if (u.pressedMouseMove && "touch" !== t.ye || (u.horzTouchDrag || u.vertTouchDrag) && "mouse" !== t.ye) {
                            var a = this.Hv.Ti();
                            null !== this.Pv || this.u_() || (this.Pv = {
                                x: t.lc,
                                y: t.fc
                            }), null === this.Pv || this.Pv.x === t.lc && this.Pv.y === t.fc || this.Fv || (a.ii() || i.nl(this.Hv, a, t.dc), i.Gl(t._c), this.Fv = !0), this.Fv && (a.ii() || i.hl(this.Hv, a, t.dc), i.Ql(t._c))
                        }
                    }
                }
                ...
                this.sv.ln(t) || (this.sv = t, this.dv.resizeCanvas({
                    width: t.st,
                    height: t.rt
                }), this.wv.resizeCanvas({
                    width: t.st,
                    height: t.rt
                }), this.$v.style.width = t.st + "px", this.$v.style.height = t.rt + "px")
                ...
                if (0 !== t && null !== this.Hv) {
                    if (t > 1 && this.c_(), null !== this.Ov && this.Ov.Dv(t), null !== this.zv && this.zv.Dv(t), 1 !== t) {
                        var i = Gi(this.dv.canvas);
                ...
                for (var h = l(this.Hv), s = t._i(h), r = h.Mt(), e = h.wt(), u = h.ct().Ol(), a = null !== u && u.Pl === t, o = null !== u && a && void 0 !== u.h_ ? u.h_.ju : void 0, f = 0, c = s; f < c.length; f++) {
                    var v = c[f].W(r, e, h);
                ...
                if (null !== this.Hv) {
                    var t = this.Yv;
                    t.I().leftPriceScale.visible || null === this.Ov || (this.Xv.removeChild(this.Ov.Kc()), this.Ov.un(), this.Ov = null), t.I().rightPriceScale.visible || null === this.zv || (this.Zv.removeChild(this.zv.Kc()), this.zv.un(), this.zv = null);
                    var i = t.ct().uf();
                    t.I().leftPriceScale.visible && null === this.Ov && (this.Ov = new cn(this, t.I().layout, i, "left"), this.Xv.appendChild(this.Ov.Kc())), t.I().rightPriceScale.visible && null === this.zv && (this.zv = new cn(this, t.I().layout, i, "right"), this.Zv.appendChild(this.zv.Kc()))
                }
        ...
        dn = function() {
            function t(t, i, n, h) {
                var s = this;
                this.Ut = !0, this.sv = new Zi(0, 0), this.lv = function() {
                    return s.Dv(3)
                }, this._v = "left" === t, this.Dl = n.uf, this.Si = i, this.x_ = h, this.Fc = document.createElement("div"), this.Fc.style.width = "25px", this.Fc.style.height = "100%", this.Fc.style.overflow = "hidden", this.dv = tn(this.Fc, new Zi(16, 16)), this.dv.subscribeCanvasConfigured(this.lv)
            }
            return t.prototype.un = function() {
                ...
                this.sv.ln(t) || (this.sv = t, this.dv.resizeCanvas({
                    width: t.st,
                    height: t.rt
                }), this.Fc.style.width = t.st + "px", this.Fc.style.minWidth = t.st + "px", this.Fc.style.height = t.rt + "px", this.Ut = !0)
            }, t.prototype.Dv = function(t) {
    ...
    var Mn = function() {
            function t(t) {
                var i = this;
                this.N_ = null, this.S_ = null, this.ae = null, this.C_ = !1, this.sv = new Zi(0, 0), this.lv = function() {
                    return i.Yv.ct().Pr()
                }, this.vv = function() {
                    return i.Yv.ct().Pr()
                }, this.Yv = t, this.Si = t.I().layout, this.D_ = document.createElement("tr"), this.T_ = document.createElement("td"), this.T_.style.padding = "0", this.E_ = document.createElement("td"), this.E_.style.padding = "0", this.Fc = document.createElement("td"), this.Fc.style.height = "25px", this.Fc.style.padding = "0", this.L_ = document.createElement("div"), this.L_.style.width = "100%", this.L_.style.height = "100%", this.L_.style.position = "relative", this.L_.style.overflow = "hidden", this.Fc.appendChild(this.L_), this.dv = tn(this.L_, new Zi(16, 16)), this.dv.subscribeCanvasConfigured(this.lv);
                var n = this.dv.canvas;
                n.style.position = "absolute", n.style.zIndex = "1", n.style.left = "0", n.style.top = "0", this.wv = tn(this.L_, new Zi(16, 16)), this.wv.subscribeCanvasConfigured(this.vv);
                var h = this.wv.canvas;
                h.style.position = "absolute", h.style.zIndex = "2", h.style.left = "0", h.style.top = "0", this.D_.appendChild(this.T_), this.D_.appendChild(this.Fc), this.D_.appendChild(this.E_), this.B_(), this.Yv.ct().Uo().Gi(this.B_.bind(this), this), this.Rc = new rn(this.wv.canvas, this, {
                    Uf: !0,
                    qf: !1
                })
            }
            return t.prototype.un = function() {
                this.Rc.un(), null !== this.N_ && this.N_.un(), null !== this.S_ && this.S_.un(), this.wv.unsubscribeCanvasConfigured(this.vv), this.wv.destroy(), this.dv.unsubscribeCanvasConfigured(this.lv), this.dv.destroy()
            }, t.prototype.Kc = function() {
                return this.D_
                ...
                this.sv && this.sv.ln(t) || (this.sv = t, this.dv.resizeCanvas({
                    width: t.st,
                    height: t.rt
                }), this.wv.resizeCanvas({
                    width: t.st,
                    height: t.rt
                }), this.Fc.style.width = t.st + "px", this.Fc.style.height = t.rt + "px"), null !== this.N_ && this.N_.Nv(new Zi(i, t.rt)), null !== this.S_ && this.S_.Nv(new Zi(n, t.rt))
                ...
                if (0 !== t) {
                    if (1 !== t) {
                        var i = Gi(this.dv.canvas);
                        this.Ev(i, this.dv.pixelRatio), this.cu(i, this.dv.pixelRatio), this.Lv(i, this.dv.pixelRatio), null !== this.N_ && this.N_.Dv(t), null !== this.S_ && this.S_.Dv(t)
                    }
                    var n = Gi(this.wv.canvas),
                ...
                var t = this.Yv.ct(),
                    i = t.I();
                i.leftPriceScale.visible || null === this.N_ || (this.T_.removeChild(this.N_.Kc()), this.N_.un(), this.N_ = null), i.rightPriceScale.visible || null === this.S_ || (this.E_.removeChild(this.S_.Kc()), this.S_.un(), this.S_ = null);
                var n = {
                    uf: this.Yv.ct().uf()
                };
                ...
                if (i.rightPriceScale.visible && null === this.S_) {
                    ...
                    this.S_ = new dn("right", this.Yv.I(), n, h), this.E_.appendChild(this.S_.Kc())
                }
            }, t
        }(),
        bn = function() {
            ...
            return t.prototype.ct = function() {
                ...
                this.D_.removeEventListener("wheel", this.G_), 0 !== this.q_ && window.cancelAnimationFrame(this.q_), this.ri.Ul().sn(this), this.ri.q().Zr().sn(this), this.ri.Uo().sn(this), this.ri.un();
                ...
                this.U_ = [], l(this.nd).un(), null !== this.D_.parentElement && this.D_.parentElement.removeChild(this.D_), this.Nl.un(), this.Iv.un()
                ...
                return O(h, s, (function() {
                    ...
                    if (t.Si.timeScale.visible) {
                        ...
                        var d = t.nd.$c();
                        o = t.nd.Xc();
                        h.drawImage(o, n, s, d.st, d.rt), t.fd() && (n += i.$c().st, _("right"), h.restore())
                    }
                })), n
            }, t.prototype.vd = function(t) {
                return "none" === t ? 0 : ("left" !== t || this.ld()) && ("right" !== t || this.fd()) ? 0 === this.j_.length ? 0 : l("left" === t ? this.j_[0].b_() : this.j_[0].m_()).Sv() : 0
                ...
                c % 2 && (c += 1);
                for (var v = f + c, _ = a < v ? 0 : a - v, d = _ / i, w = 0, M = (null === (t = document.body.ownerDocument.defaultView) || void 0 === t ? void 0 : t.devicePixelRatio) || 1, b = 0; b < this.j_.length; ++b) {
                ...
                if (3 === i && this.dd(), 3 === i || 2 === i) {
                    for (var n = this.ri.Wl(), h = 0; h < n.length; h++) t.ge(h).dh && n[h].ul();
                ...
                var i = this;
                null !== this.K_ ? this.K_.dn(t) : this.K_ = t, this.X_ || (this.X_ = !0, this.q_ = window.requestAnimationFrame((function() {
                    i.X_ = !1, i.q_ = 0, null !== i.K_ && (i.ud(i.K_), i.K_ = null)
                })))
                ...
                var n, h = new Map;
                null !== t && this.ri.O().forEach((function(i) {
                    var n = i.ia(t);
                    null !== n && h.set(i, n)
                }));
                if (null !== t) {
    ...
    function Tn(t, i) {
        if (null !== i) {
            ...
            for (var s = Dn.length - 1; s >= 0; --s)
                if (Math.floor(n.getTime() / Dn[s].yd) !== Math.floor(h.getTime() / Dn[s].yd)) return Dn[s].Is
        }
        return 20
    }
    ...
    var Pn = function() {
        function t() {
            this.xd = new Map, this.Nd = new Map, this.Sd = new Map, this.Cd = []
        }
        return t.prototype.un = function() {
            this.xd.clear(), this.Nd.clear(), this.Sd.clear(), this.Cd = []
        }, t.prototype.Dd = function(t, i) {
            var n = this;
            this.Sd.has(t) && this.xd.forEach((function(i) {
            ...
            var h = 0 !== n.length ? n[n.length - 1] : null,
                s = null;
            return null === h || i.P.Ds > h.P.Ds ? pn(i) && (n.push(i), s = {
                Bl: !1,
                zd: [i]
            ...
            0 !== i.length ? (this.Nd.set(t, i.filter(pn)), this.Sd.set(t, i[i.length - 1].P)) : (this.Nd.delete(t), this.Sd.delete(t))
            ...
            if (-1 === i && this.Cd.length !== t.length && (i = Math.min(this.Cd.length, t.length)), -1 === i) return -1;
            var r = function(i) {
                    var n = o(e.xd.get(t[i].P.Ds));
                    n.Fs = i, n.kd.forEach((function(t) {
                        t.Fs = i
                    }))
                },
                e = this;
            ...
            return function(t, i) {
                void 0 === i && (i = 0);
                for (var n = 0 === i || 0 === t.length ? null : t[i - 1].P.Ds, h = 0, s = i; s < t.length; ++s) {
                    var r = t[s];
            ...
            var t = 0;
            return this.Nd.forEach((function(i) {
            ...
            if (-1 !== n) this.Nd.forEach((function(t, i) {
                h.Vd.set(i, {
                    zd: t,
                    Bl: !0
                })
            })), this.Nd.has(t) || h.Vd.set(t, {
                zd: [],
                Bl: !0
            }), h.q.Fd = this.Cd;
            else {
    ...
    var Rn = function() {
            ...
            return t.prototype.priceFormatter = function() {
                ...
                var h = n.Ba(i.ss(), 1),
                    ...
                    r = l(n.Ta()),
                    e = l(n.Hi());
                if (null !== h && null !== s && h.Fs > s.Fs) return {
                    barsBefore: t.from - r,
                    barsAfter: e - t.to
                };
                var u = {
                ...
                return null !== h && null !== s && (u.from = h.P.Cs || h.P.Ds, u.to = s.P.Cs || s.P.Ds), u
        ...
        Gn = function() {
            ...
            return t.prototype.applyOptions = function(t) {
                ...
                return Pt(this.Ud) ? this.Ec.vd("left" === this.Ud ? "left" : "right") : 0
        ...
        Qn = function() {
            function t(t) {
                this.qd = new Z, this.ir = new Z, this.ri = t, this.Oo().$r().Gi(this.Hd.bind(this)), this.Oo().Xr().Gi(this.Yd.bind(this))
            }
            return t.prototype.un = function() {
                ...
                a(t.from <= t.to, "The from index cannot be after the to index."), this.ri.ff(t)
    ...
    var nh = function() {
        function t(t, i) {
            var n = this;
            this.Kd = new Pn, this.$d = new Map, this.Xd = new Map, this.Zd = new Z, this.Jd = new Z, this.Gd = new Z;
            var h = void 0 === i ? M(Hn) : c(M(Hn), ih(i));
            this.Ec = new bn(t, h), this.Ec.o_().Gi((function(t) {
                n.Zd.en() && n.Zd.rn(n.Qd(t()))
            }), this), this.Ec.Ul().Gi((function(t) {
                n.Jd.en() && n.Jd.rn(n.Qd(t()))
            }), this), this.Ec.ad().Gi((function(t) {
        ...
        return t.prototype.remove = function() {
            this.Ec.o_().sn(this), this.Ec.Ul().sn(this), this.iw.un(), this.Ec.un(), this.$d.clear(), this.Xd.clear(), this.Zd.un(), this.Jd.un(), this.Kd.un()
            ...
            var i = this.Ec.ct();
            i.ef(t.q.Br, t.q.Fd), t.Vd.forEach((function(t, i) {
